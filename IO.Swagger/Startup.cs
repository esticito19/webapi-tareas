            ...
            services
                .AddSwaggerGen(c =>
                {
                    c.SwaggerDoc("1.0", new Info
                    {
                        ...
                        Description = "Web API Tareas (ASP.NET Core 2.0)",
                        Contact = new Contact()
                        {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            app
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/swagger/1.0/swagger.json", "Web API Tareas");

                    //TODO: Or alternatively use the original Swagger contract that's included in the static files
                    // c.SwaggerEndpoint("/swagger-original.json", "Web API Tareas Original");
                });
